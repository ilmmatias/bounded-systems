...
* identical left observables;
* equality of the full finite matrices;
* autonomous closure of the entire route state;
* equality of the two time normalizations.
...
* the right-state angle decreased with horizon, reaching about (0.21°) at (\rho=3/8);
