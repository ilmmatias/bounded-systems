...
The alternating signs are not imposed externally. They arise automatically from multiplying the two differences.
...
This reinforces the central conclusion from the finite experiments:
