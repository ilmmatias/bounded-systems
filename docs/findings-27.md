...
\operatorname*{w^\ast-lim}*{r\uparrow R_u^+}
\varphi*{u,r},
]
...
This name is descriptive rather than an added axiom or asserted standard terminology.
...
\varphi_{u,\partial}|*{\mathcal D*{\mathrm{cyl}}}
