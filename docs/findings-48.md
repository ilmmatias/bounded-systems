...
Thus the profile was not merely changing slowly because of the raw (1/n) step size. The scaled drift itself was approaching zero:
...
The table-construction phase was serial in the first implementation and stored a large sequence of exact powers of two. That later became an important engineering bottleneck at (N\gtrsim600), but it did not alter the sampled law.
