...
This is not an added metric on the original system. It is the ordinary finite-coordinate geometry of the already-derived real-valued Martin profiles.
...
\Longrightarrow
d*{B_n(o)}(h_\xi,h_\eta)<\varepsilon
\end{array}
\right}.
}
]
