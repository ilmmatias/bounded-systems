...
It is a purely formal identity.
...
This is exactly why route collapse is always algebraically meaningful on finite-support expressions but may fail as a bounded operation on the Fock completion.
...
This is not the original path-counting kernel.
