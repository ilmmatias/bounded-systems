...
The first failure concerns branching somewhere from a source. The second concerns lack of a uniform endpoint-fiber bound. The third requires an actually infinite route fiber.
...
Again, none of these local-finiteness assumptions follow from A1–A5.
