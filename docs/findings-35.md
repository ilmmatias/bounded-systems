...
So the quadratic equation is not an artifact. It is the exact conversion between:
...
The metric is not merely a static distinguishability tensor. It is the pathwise fluctuation tensor of the dynamics encoded by the harmonic profile.
...
No stationarity and no cycles are needed.
...
The positive profile does not merely label the dynamics. Its logarithmic gradient **is the additional effective drift**.
