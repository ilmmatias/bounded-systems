...
[
c:\quad
u=x_0<*\alpha x_1<*\alpha\cdots<_\alpha x_m=v
]
...
This is stronger than merely saying that the complex is finite-dimensional: it identifies the exact region in which filtered coherence can occur.
...
This specialization is legitimate when the series is a polynomial or otherwise converges. It is not automatically meaningful for an arbitrary infinite interval.
