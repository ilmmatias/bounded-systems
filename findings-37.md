...
The important part is that the harmonic profile still determines the effective dynamics.
...
Therefore the correct anomalous object is not an infinite higher-derivative PDE. It is the jump integral.
...
So fractional time need not be postulated externally. It can emerge from the distribution of microscopic path lengths between coarse profile events.
