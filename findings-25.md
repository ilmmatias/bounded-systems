...
It is not generally compatible isometrically.
...
That is precisely the diamond relation.
...
A particularly important phenomenon occurs when every lower-level endpoint fiber is finite, but infinitely many intermediate nodes contribute.
...
We can now state the central distinction.
